...
# L4 GPU용 CUDA 및 NVIDIA 드라이버 설치 스크립트
# L4 GPU는 최신 Ada Lovelace 아키텍처를 사용하므로 최신 드라이버 필요

echo "=== L4 GPU용 CUDA 설치 시작 ==="
...
# L4 GPU용 최신 NVIDIA 드라이버 설치 (550-server 계열 + 유틸 포함)
...
# CUDA Toolkit 12.2 설치 (L4 GPU 최적화)
